# taken from the Oskar's file custum_vae_ow.py => the CancerAI modified VAE
# it does not concatenate inputs
...
class CNCVAE:
    ...
    def build_model(self):
        np.random.seed(42)
        tf.random.set_seed(42)  ### MZ change tf.random.set_random_seed(42)
