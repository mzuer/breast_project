...
# python breast_proteo_johansonn_VAE.py
...
wd = os.path.join('/home','marie','Documents','FREITAS_LAB','breast_project','CancerAI_VAE')
os.chdir(wd)
...
outfolder = os.path.join('BREAST_PROTEO_JOHANSSON_VAE')
os.makedirs(outfolder, exist_ok=True)

import vae_ow
from vae_ow import *  ### I am sure the class is imported from there because I had to change the set seed
...
input_data = os.path.join('/home', 'marie' ,'Documents', 'FREITAS_LAB', 'breast_project', 'data', 'johansson_data_relative_ratios_to_pool.csv')
