...
# python breast_proteo_johansonnMostVar_VAE.py
...
outfolder = os.path.join('BREAST_PROTEO_JOHANSSONMOSTVAR_VAE')
...
input_data = os.path.join('/home', 'marie' ,'Documents', 'FREITAS_LAB', 'breast_project', 'data', 'johansson_data_relative_ratios_to_pool_1000mostVar.txt')
