...
outFile <- file.path(outFolder, paste0("modules_dt.Rdata"))
save(modules_dt, file=outFile)
...
outFile <- file.path(outFolder, paste0(cond1, "_", cond2,"_profile_plot.svg"))
ggsave(p[[1]], filename = outFile, height=myHeightGG*1.3, width=myWidthGG)
cat(paste0("... written: ", outFile, "\n"))
...
outFile <- file.path(outFolder, "cem_cond12.Rdata")
save(cem_cond12, file = outFile)
cat(paste0("... written: ", outFile, "\n"))
